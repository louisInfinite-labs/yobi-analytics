...
export function AnimatedRingChart({ contributions }: AnimatedRingChartProps) {
    ...
    <div className="card ring-chart">
      ...
      <div style={{ width: "100%", height: 160, position: "relative" }}>
        ...
        >
          ...
          <span style={{ fontSize: 11, color: "var(--text-tertiary)" }}>of today's growth</span>
        </div>
      </div>
      <span className="sr-only">
        {top.channelName} contributed {top.percent.toFixed(1)} percent of today's total growth.
      </span>
